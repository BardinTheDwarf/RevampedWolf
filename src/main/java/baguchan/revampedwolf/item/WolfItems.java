...
public class WolfItems {
    ...
    public static final Item NETHERITE_WOLF_ARMOR = new WolfArmorItem(ArmorMaterial.NETHERITE, 20, "netherite", (new Item.Properties()).isImmuneToFire().maxStackSize(1).maxDamage(858).group(ItemGroup.MISC));
